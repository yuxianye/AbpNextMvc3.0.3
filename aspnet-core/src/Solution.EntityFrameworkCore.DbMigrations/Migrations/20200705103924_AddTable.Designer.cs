...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Solution.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Solution.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Solution.Orders.OrderStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Solution.ProcessRoutes.CheckType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Solution.ProcessRoutes.ControlCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Solution.ProcessRoutes.Process", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Solution.Enterprises.EnterpriseArea", b =>
                {
                    b.HasOne("Solution.Enterprises.EnterpriseSite", "EnterpriseSite")
                        .WithMany()
            ...
            modelBuilder.Entity("Solution.Enterprises.EnterpriseProductionLine", b =>
                {
                    b.HasOne("Solution.Enterprises.EnterpriseArea", "EnterpriseArea")
                        .WithMany()
            ...
            modelBuilder.Entity("Solution.Enterprises.EnterpriseSite", b =>
                {
                    b.HasOne("Solution.Enterprises.Enterprise", "Enterprise")
                        .WithMany()
            ...
            modelBuilder.Entity("Solution.Enterprises.EnterpriseWorkCenter", b =>
                {
                    b.HasOne("Solution.Enterprises.EnterpriseProductionLine", "EnterpriseProductionLine")
                        .WithMany()
            ...
            modelBuilder.Entity("Solution.Enterprises.EnterpriseWorkLocation", b =>
                {
                    b.HasOne("Solution.Enterprises.EnterpriseWorkCenter", "EnterpriseWorkCenter")
                        .WithMany()
                        .HasForeignKey("EnterpriseWorkCenterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Solution.Equipments.Equipment", "Equipment")
                        .WithMany()
                        .HasForeignKey("EquipmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Solution.ProcessRoutes.Process", "Process")
                        .WithMany()
            ...
            modelBuilder.Entity("Solution.Equipments.Equipment", b =>
                {
                    b.HasOne("Solution.Equipments.EquipmentBrand", "EquipmentBrand")
                        .WithMany()
                        .HasForeignKey("EquipmentBrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Solution.Equipments.EquipmentStatus", "EquipmentStatus")
                        .WithMany()
                        .HasForeignKey("EquipmentStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Solution.Equipments.EquipmentType", "EquipmentType")
                        .WithMany()
            ...
            modelBuilder.Entity("Solution.Equipments.EquipmentMaintenance", b =>
                {
                    ...
                    b.HasOne("Solution.Equipments.EquipmentMaintenanceResult", "EquipmentMaintenanceResult")
                        .WithMany()
            ...
            modelBuilder.Entity("Solution.Equipments.EquipmentSparePart", b =>
                {
                    b.HasOne("Solution.Equipments.EquipmentSparePartType", "EquipmentSparePartType")
                        .WithMany()
            ...
            modelBuilder.Entity("Solution.Materials.BOM", b =>
                {
                    b.HasOne("Solution.Materials.Material", "Material")
                        .WithMany()
            ...
            modelBuilder.Entity("Solution.Materials.Material", b =>
                {
                    b.HasOne("Solution.Public.Unit", "Unit")
                        .WithMany()
            ...
            modelBuilder.Entity("Solution.Materials.Product", b =>
                {
                    b.HasOne("Solution.Materials.ProductType", "ProductType")
                        .WithMany()
            ...
            modelBuilder.Entity("Solution.Orders.Order", b =>
                {
                    b.HasOne("Solution.Customers.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Solution.Orders.OrderStatus", "OrderStatus")
                        .WithMany()
                        .HasForeignKey("OrderStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Solution.Materials.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Solution.ProcessRoutes.Process", b =>
                {
                    b.HasOne("Solution.ProcessRoutes.CheckType", "CheckType")
                        .WithMany()
                        .HasForeignKey("CheckTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Solution.ProcessRoutes.ControlCode", "ControlCode")
                        .WithMany()
            ...
            modelBuilder.Entity("Solution.Qualities.QualityInspect", b =>
                {
                    ...
                    b.HasOne("Solution.Qualities.QualityInspectResult", "QualityInspectResult")
                        .WithMany()
                        .HasForeignKey("QualityInspectResultId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Solution.Qualities.QualityInspectType", "QualityInspectType")
                        .WithMany()
                        .HasForeignKey("QualityInspectTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Solution.Qualities.QualityProblemLib", "QualityProblemLib")
                        .WithMany()
            ...
            modelBuilder.Entity("Solution.Suppliers.Suppliers", b =>
                {
                    b.HasOne("Solution.Suppliers.SupplierLevel", "SupplierLevel")
                        .WithMany()
            ...
            modelBuilder.Entity("Solution.Warehouses.WarehouseArea", b =>
                {
                    b.HasOne("Solution.Warehouses.Warehouse", "Warehouse")
                        .WithMany()
            ...
            modelBuilder.Entity("Solution.Warehouses.WarehouseLocation", b =>
                {
                    b.HasOne("Solution.Warehouses.WarehouseArea", "WarehouseArea")
                        .WithMany()
